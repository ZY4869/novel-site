...
wrangler d1 execute novel-db --file migrations/005_reading_progress.sql --remote
wrangler d1 execute novel-db --file migrations/006_github_repo_scan_cache.sql --remote
```
